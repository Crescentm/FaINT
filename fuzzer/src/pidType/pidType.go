...
func Constructor(inputdata INPUTDATA, inputType INPUTTYPE, cost COST, path []int64, status []string) PID {
	pid := PID{InputData: inputdata, InputType: inputType, Cost: cost, Path: path, Status: status}
	return pid
}
